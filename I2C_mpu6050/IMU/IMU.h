...
void setPureRotateFlag(bool st);
bool isPureRotate();
void updateDownwardRot();
float get_InputGz();
void Intial_IMU_POWER();
...
void toQuaternion(Q4* q, float yaw, float pitch, float roll);
void getRotationMatrix(float R[9], Q4 q);
