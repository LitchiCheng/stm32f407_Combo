...
#include "delay.h"
#include "I2CDriver.h"
#define i2c_write   i2c::Instance()->i2c_write
#define i2c_read    i2c::Instance()->i2c_read
...
#define log_i     printf2
#define log_e     printf2
        ...
        unsigned char *data)
{
	...
	u8 temp4[1]={0};
	  i2c_read(0x68,0x75,1,temp4);
		printf2("who am i is %d\n",temp4[0]);
    if (i2c_write(st.hw->addr, st.reg->mem_r_w, length, data))
        return -1;
	
	u8 temp5[1]={0};
	  i2c_read(0x68,0x75,1,temp5);
		printf2("who am i is %d\n",temp5[0]);
    return 0;
}
        ...
        unsigned char *data)
{
	...
	u8 temp4[1]={0};
	  i2c_read(0x68,0x75,1,temp4);
		printf2("who am i is %d\n",temp4[0]);
    if (i2c_read(st.hw->addr, st.reg->mem_r_w, length, data))				//这里出了问题！！！！！！！！！！！！
        return -1;
	u8 temp5[1]={0};
	  i2c_read(0x68,0x75,1,temp5);
		printf2("who am i is %d\n",temp5[0]);
